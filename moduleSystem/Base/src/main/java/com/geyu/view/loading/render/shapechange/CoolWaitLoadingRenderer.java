package com.geyu.view.loading.render.shapechange;
...
public class CoolWaitLoadingRenderer extends LoadingRenderer {
    ...
    private void init(Context context) {
        mWidth = DisplayUtils.dip2px(  DEFAULT_WIDTH);
        mHeight =DisplayUtils.dip2px(  DEFAULT_HEIGHT);
        mStrokeWidth = DisplayUtils.dip2px(  DEFAULT_STROKE_WIDTH);
        mWaitCircleRadius = DisplayUtils.dip2px(  WAIT_CIRCLE_RADIUS);
