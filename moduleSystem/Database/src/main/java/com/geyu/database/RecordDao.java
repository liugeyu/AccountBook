...
public class RecordDao extends AbstractDao<Record, Long> {
    ...
    public static class Properties {
        ...
        public final static Property CategoryUniqueName = new Property(3, String.class, "categoryUniqueName", false, "CATEGORY_UNIQUE_NAME");
        public final static Property CategoryName = new Property(4, String.class, "categoryName", false, "CATEGORY_NAME");
        public final static Property CategoryIcon = new Property(5, String.class, "categoryIcon", false, "CATEGORY_ICON");
        ...
        public final static Property SyncId = new Property(8, String.class, "syncId", false, "SYNC_ID");
        public final static Property SyncStatus = new Property(9, int.class, "syncStatus", false, "SYNC_STATUS");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"RECORD\" (" + //
                ...
                "\"CATEGORY_UNIQUE_NAME\" TEXT," + // 3: categoryUniqueName
                "\"CATEGORY_NAME\" TEXT," + // 4: categoryName
                "\"CATEGORY_ICON\" TEXT," + // 5: categoryIcon
                "\"AMOUNT\" INTEGER NOT NULL ," + // 6: amount
                "\"DESC\" TEXT," + // 7: desc
                "\"SYNC_ID\" TEXT," + // 8: syncId
                "\"SYNC_STATUS\" INTEGER NOT NULL ," + // 9: syncStatus
    ...
    protected final void bindValues(DatabaseStatement stmt, Record entity) {
        ...
        if (categoryUniqueName != null) {
            stmt.bindString(4, categoryUniqueName);
        }
        ...
        if (categoryIcon != null) {
            stmt.bindString(6, categoryIcon);
        }
        ...
        if (syncId != null) {
            stmt.bindString(9, syncId);
        }
        stmt.bindLong(10, entity.getSyncStatus());
    ...
    public Record readEntity(Cursor cursor, int offset) {
        Record entity = new Record( //
            ...
            cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3), // categoryUniqueName
            cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4), // categoryName
            cursor.isNull(offset + 5) ? null : cursor.getString(offset + 5), // categoryIcon
            cursor.getLong(offset + 6), // amount
            cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7), // desc
            cursor.isNull(offset + 8) ? null : cursor.getString(offset + 8), // syncId
            cursor.getInt(offset + 9), // syncStatus
    ...
    public void readEntity(Cursor cursor, Record entity, int offset) {
        ...
        entity.setCategoryUniqueName(cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3));
        entity.setCategoryName(cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4));
        entity.setCategoryIcon(cursor.isNull(offset + 5) ? null : cursor.getString(offset + 5));
        entity.setAmount(cursor.getLong(offset + 6));
        entity.setDesc(cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7));
        entity.setSyncId(cursor.isNull(offset + 8) ? null : cursor.getString(offset + 8));
        entity.setSyncStatus(cursor.getInt(offset + 9));
